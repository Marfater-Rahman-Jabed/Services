...
import invoiceBg from '../../assets/invoiceimagebg2.png'
    ...
    return (
        <div className='flex justify-between '>
                ...
                <div className=" print:w-0 print:hidden bg-purple-400 pt-10 pb-6 px-6">
                    ...
                    <div className='flex justify-between gap-2'>
                        ...
                        <div className="form-control w-full pt-9">
                            ...
                            <button className='w-full btn btn-secondary' onClick={() => document.getElementById('my_modal_4').showModal()}>Upload Payment Information</button>
            ...
            <div className='w-1/2 print:w-full ' >
                <div >
                    <Watermark content={watermark} gap={[40, 40]} offset={[70, 70]} className='border-8 border-solid border-blue-900'>
                        <div style={{ backgroundImage: `url(${invoiceBg})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', }} className='py-6'>
                            <h3 className='text-5xl text-center font-bold text-white font-serif mb-2'>INVOICE</h3>
                            <span className='font-semibold text-white'>
                                <h3 className='font-bold text-3xl mb-1 text-center'>{companyName}</h3>
                        ...
                        <div className='flex justify-around gap-2   px-6'>
                            <div className='pt-4'>
                                ...
                                <span className='font-semibold '>
                                    <p className='italic font-semibold mb-1'>Delivered To</p>
                            ...
                            <div>
                                ...
                                <span className='flex justify-between gap-2 pt-20'>
                                    <span className='font-semibold '>
                        ...
                        <div>
                            <div className='px-6'>
                                <div className="overflow-x-auto   pt-10 pb-2">
                                    <table className="table  border-2 border-solid border-blue-500 font-bold">
                                        {/* head */}
                                        <thead>
                            ...
                            <div className='flex justify-between gap-4'>
                                <div className='pt-8 px-10  '>
                                    <h3 className='font-bold pb-2'>Payment Information:</h3>
                                ...
                                <div className='pe-4'>
                                    <span className='text-center'> <img src={uploadedImage} alt="" className='pt-8' /></span>
                                    <hr />
                        ...
                        <div style={{ backgroundImage: `url(${invoiceBg})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', }} className='py-4'>
                ...
                <div className="modal-box">
                    <form action="" method="dialog" className='py-4'>
                        ...
                        <div className='gap-2 pt-6'>
                            <div className="form-control w-full ">
                                <label className="label">
                                    <span className="label-text">Set Your Payment Information</span>
