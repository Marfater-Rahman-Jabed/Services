    ...
    return (
        <div className='flex justify-between'>
            <div className='w-1/2 print:hidden'>
                <div className=" print:w-0 print:hidden bg-purple-400 pt-10 px-6">
                ...
                <Watermark content={watermark} gap={[40, 40]} offset={[70, 70]}>
                    ...
                    <div>
                        ...
                        <div className='flex justify-center pt-8 print:hidden'>
                            <button className='btn btn-secondary px-10' onClick={handlePrint}>Print Now</button>
                        </div>
                    </div>
                </Watermark>
            </div>
