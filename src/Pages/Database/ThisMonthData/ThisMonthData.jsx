...
const ThisMonthData = () => {
    ...
    const todayDate = new Date().toString().slice(4, 7)
    ...
    return (
        <div>
            <div className="flex justify-between px-3  py-2">
                ...
                <p className="text-3xl font-bold text-center">Month ({todayDate}) Uploaded Data List</p>
                <DownloadTableExcel
                    filename="This Month Data table"
                    sheet="users"
            ...
            <div className="text-center">
                <div className=" py-2">
                    <table className="table table-zebra" ref={tableRef}>
                        ...
                        <tbody>
                            {
                                findData.filter(data => data.date.slice(4, 7) === todayDate).map((data, i) => <tr key={i} className="hover">
                                    <td>{i + 1}</td>
                                    {
