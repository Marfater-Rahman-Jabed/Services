...
const TodaysData = () => {
    ...
    const todatDate = new Date().toString().slice(0, 16)
    ...
    return (
        <div>
            <div className="flex justify-between px-3  py-2">
                ...
                <p className="text-3xl font-bold text-center">Today Uploaded Data List</p>
                <DownloadTableExcel
                    filename="Todays data table"
                    sheet="users"
            ...
            <div className="text-center">
                <div className=" py-2">
                    <table className="table table-zebra" ref={tableRef}>
                        ...
                        <tbody>
                            {
                                findData.filter(data => data.date.slice(0, 16) === todatDate).map((data, i) => <tr key={i} className="hover">
                                    <td>{i + 1}</td>
                                    {
